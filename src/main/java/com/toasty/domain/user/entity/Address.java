...
/**
 * 유저의 주소 Entity. 카카오 우편번호 서비스가 내려준 값과 유저가 입력한 상세주소를 담는다. 한 유저가 여러 개를 가질 수 있고, 그중 하나가 기본 주소다.
 *
...
public class Address extends BaseTimeEntity {
    ...
    // 기본 주소 여부. 유저당 하나만 true인 것은 Service에서 보장한다 (MySQL은 조건부 unique를 못 건다)
